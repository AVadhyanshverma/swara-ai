...
2. **For Images & Videos (.jpg, .png, .mp4, etc.):** 
   - The tool uploads the file temporarily via Hugging Face and passes it to the `stepfun-ai/step-3.7-flash` vision model (via NVIDIA NIM) to generate a detailed description.
